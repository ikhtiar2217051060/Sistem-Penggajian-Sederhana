                ...
                <div class="p-4">
                    ...
                    <div class="card card-custom">
                        <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center flex-wrap">
                            <h6 class="mb-0 fw-bold">Daftar Penggajian</h6>
                            <div class="d-flex align-items-center gap-2">
                                <div class="input-group input-group-sm w-auto">
                                    <span class="input-group-text"><i class="fas fa-search"></i></span>
                                    <input type="search" class="form-control" placeholder="Cari..." data-table-search="#tablePenggajian">
                                </div>
                                <a href="<?= base_url('penggajian/create') ?>" class="btn btn-primary btn-sm"><i class="fas fa-plus me-1"></i>Buat Penggajian</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover" id="tablePenggajian">
                                    <thead><tr><th>#</th><th>NIP</th><th>Nama</th><th>Departemen</th><th>Periode</th><th>Total Gaji</th><th>Status</th><th>Aksi</th></tr></thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('penggajian/detail/' . $row['id']) ?>" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a>
                                                <a href="<?= base_url('penggajian/slip/' . $row['id']) ?>" class="btn btn-sm btn-success" target="_blank"><i class="fas fa-receipt"></i></a>
                                                <a href="<?= base_url('penggajian/edit/' . $row['id']) ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                                <a href="<?= base_url('penggajian/delete/' . $row['id']) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin?')"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
