                ...
                <div class="p-4">
                    ...
                    <div class="card card-custom">
                        <div class="card-header bg-white border-0">
                            <h6 class="mb-0 fw-bold">Buat Penggajian Baru</h6>
                        </div>
                        <div class="card-body">
                            <form action="<?= base_url('penggajian/store') ?>" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="id_karyawan" required>
                                                ...
                                                <?php foreach ($karyawan as $k): ?>
                                                    <option value="<?= $k['id'] ?>"><?= $k['nip'] ?> - <?= $k['nama_lengkap'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label fw-bold">Periode</label>
                                            <input type="month" class="form-control" name="periode" value="<?= $periode ?>" required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label fw-bold">Tanggal Gaji</label>
                                            <input type="date" class="form-control" name="tanggal_gaji" value="<?= date('Y-m-25') ?>" required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label fw-bold">Tunjangan Makan (Rp)</label>
                                            <input type="number" class="form-control" name="tunjangan_makan" value="0" min="0">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label fw-bold">Tunjangan Transport (Rp)</label>
                                            <input type="number" class="form-control" name="tunjangan_transport" value="0" min="0">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label fw-bold">Tunjangan Lain (Rp)</label>
                                            <input type="number" class="form-control" name="tunjangan_lain" value="0" min="0">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label fw-bold">Potongan Lain (Rp)</label>
                                            <input type="number" class="form-control" name="potongan_lain" value="0" min="0">
                                        </div>
                                        <div class="mb-3">
                                ...
                                <div class="alert alert-info">
                                    ...
                                    <strong>Perhitungan otomatis:</strong> Gaji pokok dan tunjangan jabatan diambil dari jabatan karyawan.
                                    Potongan PPH 5% dihitung otomatis.
                                </div>
                                <div class="d-flex justify-content-between">
                                    <a href="<?= base_url('penggajian') ?>" class="btn btn-secondary"><i class="fas fa-arrow-left me-1"></i>Kembali</a>
                                    <button type="submit" class="btn btn-primary"><i class="fas fa-save me-1"></i>Simpan Penggajian</button>
                                </div>
                            </form>
                        </div>
                    </div>
