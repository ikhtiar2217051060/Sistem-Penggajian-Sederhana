                ...
                <div class="p-4">
                    <div class="card card-custom">
                        <div class="card-header bg-white border-0">
                            <h6 class="mb-0 fw-bold"><?= isset($departemen) ? 'Edit Departemen' : 'Tambah Departemen Baru' ?></h6>
                        </div>
                        <div class="card-body">
                            <form action="<?= isset($departemen) ? base_url('departemen/update/' . $departemen['id']) : base_url('departemen/store') ?>" method="post">
                                <div class="mb-3">
                                    <label class="form-label fw-bold">Nama Departemen</label>
                                    <input type="text" class="form-control" name="nama_departemen" value="<?= $departemen['nama_departemen'] ?? '' ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fw-bold">Keterangan</label>
                                    <textarea class="form-control" name="keterangan" rows="3"><?= $departemen['keterangan'] ?? '' ?></textarea>
                                </div>
                                <div class="d-flex justify-content-between">
                                    <a href="<?= base_url('departemen') ?>" class="btn btn-secondary"><i class="fas fa-arrow-left me-1"></i>Kembali</a>
