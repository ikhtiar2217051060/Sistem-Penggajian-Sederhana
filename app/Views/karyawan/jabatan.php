                ...
                <div class="p-4">
                    ...
                    <div class="card card-custom">
                        <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center flex-wrap">
                            <h6 class="mb-0 fw-bold">Daftar Jabatan</h6>
                            <div class="d-flex align-items-center gap-2">
                                <div class="input-group input-group-sm w-auto">
                                    <span class="input-group-text"><i class="fas fa-search"></i></span>
                                    <input type="search" class="form-control" placeholder="Cari..." data-table-search="#tableJabatan">
                                </div>
                                <a href="<?= base_url('jabatan/create') ?>" class="btn btn-primary btn-sm"><i class="fas fa-plus me-1"></i>Tambah Jabatan</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover" id="tableJabatan">
                                    <thead><tr><th>#</th><th>Nama Jabatan</th><th>Departemen</th><th>Gaji Pokok</th><th>Tunjangan</th><th>Aksi</th></tr></thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('jabatan/edit/' . $row['id']) ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                                <a href="<?= base_url('jabatan/delete/' . $row['id']) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin?')"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
