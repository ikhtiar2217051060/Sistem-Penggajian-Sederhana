                ...
                <div class="p-4">
                    <div class="card card-custom">
                        <div class="card-header bg-white border-0">
                            <h6 class="mb-0 fw-bold"><?= isset($karyawan) ? 'Edit Data Karyawan' : 'Tambah Data Karyawan Baru' ?></h6>
                        </div>
                        <div class="card-body">
                            <form action="<?= isset($karyawan) ? base_url('karyawan/update/' . $karyawan['id']) : base_url('karyawan/store') ?>" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label fw-bold">NIP</label>
                                            <input type="text" class="form-control" name="nip" value="<?= $karyawan['nip'] ?? '' ?>" required>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="jenis_kelamin" required>
                                                ...
                                                <option value="Laki-laki" <?= (isset($karyawan) && $karyawan['jenis_kelamin'] == 'Laki-laki') ? 'selected' : '' ?>>Laki-laki</option>
                                                <option value="Perempuan" <?= (isset($karyawan) && $karyawan['jenis_kelamin'] == 'Perempuan') ? 'selected' : '' ?>>Perempuan</option>
                                            </select>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="agama">
                                                <option value="">Pilih</option>
                                                <?php $agama_list = ['Islam', 'Kristen', 'Katolik', 'Hindu', 'Buddha', 'Konghucu']; foreach($agama_list as $a): ?>
                                                <option value="<?= $a ?>" <?= (isset($karyawan) && $karyawan['agama'] == $a) ? 'selected' : '' ?>><?= $a ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="id_departemen" required>
                                                ...
                                                <option value="<?= $d['id'] ?>" <?= (isset($karyawan) && $karyawan['id_departemen'] == $d['id']) ? 'selected' : '' ?>><?= $d['nama_departemen'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="id_jabatan" required>
                                                ...
                                                <option value="<?= $j['id'] ?>" <?= (isset($karyawan) && $karyawan['id_jabatan'] == $j['id']) ? 'selected' : '' ?>><?= $j['nama_jabatan'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="status_kerja" required>
                                                <option value="aktif" <?= (isset($karyawan) && $karyawan['status_kerja'] == 'aktif') ? 'selected' : '' ?>>Aktif</option>
                                                <option value="cuti" <?= (isset($karyawan) && $karyawan['status_kerja'] == 'cuti') ? 'selected' : '' ?>>Cuti</option>
                                                <option value="resign" <?= (isset($karyawan) && $karyawan['status_kerja'] == 'resign') ? 'selected' : '' ?>>Resign</option>
                                                <option value="mutasi" <?= (isset($karyawan) && $karyawan['status_kerja'] == 'mutasi') ? 'selected' : '' ?>>Mutasi</option>
                                            </select>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label fw-bold">NPWP</label>
                                            <input type="text" class="form-control" name="npwp" value="<?= $karyawan['npwp'] ?? '' ?>">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label fw-bold">No Rekening</label>
                                            <input type="text" class="form-control" name="no_rekening" value="<?= $karyawan['no_rekening'] ?? '' ?>">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label fw-bold">Nama Bank</label>
                                            <input type="text" class="form-control" name="nama_bank" value="<?= $karyawan['nama_bank'] ?? '' ?>">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label fw-bold">Status Pernikahan</label>
                                            <select class="form-control" name="status_pernikahan">
                                                <option value="belum_menikah" <?= (isset($karyawan) && $karyawan['status_pernikahan'] == 'belum_menikah') ? 'selected' : '' ?>>Belum Menikah</option>
                                                <option value="menikah" <?= (isset($karyawan) && $karyawan['status_pernikahan'] == 'menikah') ? 'selected' : '' ?>>Menikah</option>
                                                <option value="cerai" <?= (isset($karyawan) && $karyawan['status_pernikahan'] == 'cerai') ? 'selected' : '' ?>>Cerai</option>
                                            </select>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label fw-bold">Jumlah Tanggungan</label>
                                            <input type="number" class="form-control" name="jumlah_tanggungan" value="<?= $karyawan['jumlah_tanggungan'] ?? 0 ?>" min="0">
                                        </div>
                                    </div>
                                </div>
                                <hr>
